...
class DataExtractor:
        ...
        try:
            for pattern in gst_patterns:
                for match in re.finditer(pattern, text, re.IGNORECASE):
                    ...
                    if self._validate_gst_number(gst_number):
    ...
    def extract_table_data(self, image):
        ...
        try:
            ...
            table_found, table_region, cells = self.table_extractor.detect_table_region(image)
            ...
            table_data = self.table_extractor._extract_table_data_from_cells(cells, [])
