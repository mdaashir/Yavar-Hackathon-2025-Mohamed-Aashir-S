...
class TableFormatDetector:
    ...
    def analyze_table_structure(self, image: np.ndarray, cells: List[Dict[str, Any]]) -> TableRegion:
        """
        ...
        return TableRegion(
            ...
            confidence=self._calculate_format_confidence(rows, table_format)
        )

    def _group_cells_into_rows(self, cells: List[Dict[str, Any]]) -> List[List[Dict[str, Any]]]:
        """
    ...
    def _calculate_format_confidence(self, rows: List[List[Dict[str, Any]]], 
    ...
    def extract_structured_data(self, region: TableRegion) -> List[Dict[str, Any]]:
        ...
        rows = self._group_cells_into_rows(region.cells)
